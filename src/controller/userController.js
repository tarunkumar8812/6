...
async function getProfile(req, res) {
    try {
        ...
        let userProfile = await accountModel.findOne({ loginId: loginId, password: password, isDeleted: false }).select({
...
async function accountStatement(req, res) {
    try {
        ...
        let accountStatement = await transactionModel.find({ accountNumber: accountNumber }, { IFSC: IFSC }).select({
